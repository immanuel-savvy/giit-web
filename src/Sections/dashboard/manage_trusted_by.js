...
import Add_new_trusted_by from "./add_new_trustes_by";
import Dashboard_breadcrumb from "./dashboard_breadcrumb";

class Manage_trusted_by extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="col-lg-9 col-md-9 col-sm-12">
        ...
        <div class="row">
          {show_form ? (
            <div>
              <Add_new_trusted_by toggle={this.toggle_form} />
              <hr />
            </div>
          ) : null}
...
export default Manage_trusted_by;
