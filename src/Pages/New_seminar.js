...
class New_seminar extends Handle_image_upload {
  constructor(props) {
    super(props);
  ...
  handle_images = async (e) => {
    this.handle_image(
      ...
      null,
      () => {
        let { image, images, image_hash } = this.state;

        images = new Array({ url: image, image_hash }, ...images);
        ...
        {({ loggeduser }) => {
          ...
          return (
            <div id="main-wrapper">
              ...
              <Breadcrumb page_title="New Seminar" />
