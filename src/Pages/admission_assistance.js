...
class Admission_assistance extends React.Component {
  constructor(props) {
    super(props);
  ...
  fetch_articles = async (page = this.state.page) => {
    ...
    let { articles, total_articles } = await post_request(
  ...
  render() {
    ...
    return (
      <div id="main-wrapper">
        <Header page="admission assistance" />
        <Breadcrumb
          page_title="admission assistance"
          page_text="admission assistance"
        />
        <section class="min">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-7 col-md-8">
                <div class="sec-heading center">
                  <h2>
                    Latest News on <span class="theme-cl">Admissions</span>
                  </h2>
                  <p>
...
export default Admission_assistance;
